...
private:
    ...
    void            paintRect( const QPointF& pos, const QColor& fillColor, const QColor& penColor, const int size );
    void            paintEllipse( const QPointF& pos, const QColor& fillColor, const QColor& penColor, const int size );
    void            paintCircle( const QPointF& pos, const QColor& fillColor, const QColor& penColor, const int size );
    void            paintHexagon( const QPointF& pos, const QColor& fillColor, const QColor& penColor, const int size );
    void            paintStar( const QPointF& pos, const QColor& fillColor, const QColor& penColor, const int size );
